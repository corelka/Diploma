...
namespace Diploma.Migrations
{
    public partial class newMachine : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_LectureNotes_Subject_SubjectId", table: "LectureNotes");
            migrationBuilder.DropForeignKey(name: "FK_LectureNotes_Teacher_TeacherId", table: "LectureNotes");
